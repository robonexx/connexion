...
const mockData: PostItemProps[] = [
  {
    ...
    image:
      'https://images.pexels.com/photos/4637225/pexels-photo-4637225.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load',
    title: 'First Post',
  ...
  },
  {
    ...
    image:
      'https://images.pexels.com/photos/12437649/pexels-photo-12437649.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load',
    title: 'Second Post',
  ...
  },
  {
    ...
    image:
      'https://images.pexels.com/photos/16307204/pexels-photo-16307204/free-photo-of-ljus-svartvitt-stad-man.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load',
    title: 'Third Post',
...
const Dashboard = async ({ searchParams }: SearchTypes) => {
  ...
  return (
    <div className='relative flex min-h-screen h-full w-full flex-col items-center red-gradient py-20 px-20'>
      <h1 className='text-4xl tracking-wide font-semibold capitalize text-[#ff4040]'>
        Senaste inlägg!
      </h1>
      <div className='min-h-screen pt-8 pb-8'>
        <div className='w-fit max-w-4xl grid place-items-center mx-auto bg-transparent'>
          <section className='w-full h-full flex flex-col md:flex-row md:flex-wrap gap-5'>
            {posts.map(
              ({ _id, createdAt, title, tags, body, image, author }) => (
                <Post
                  key={_id}
                  title={title}
                  createdAt={createdAt}
